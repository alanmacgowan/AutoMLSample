...
namespace AutoMLSampleML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\CODE\ML\AutoMLSample\AutoMLSample\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../AutoMLSampleML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options() { NumberOfLeaves = 71, MinimumExampleCountPerLeaf = 1, NumberOfTrees = 100, LearningRate = 0.3458574f, Shrinkage = 1.924274f, LabelColumnName = "fare_amount", FeatureColumnName = "Features" });
